...
if __name__ == '__main__':
    ...
    for i in prop_name:
        ...
        # data, datasize = data_generator(pmc_result[i][2], pmc_result[i][3], application, 0,30)
        # data_length, decision = system_level_prop_eval(data, requirement[i], pmc_result[i])
        # print(requirement[i])
