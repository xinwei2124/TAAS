...
legend('Noise high','Noise low','Noise free','Baseline','fontsize',18,'edgecolor','w'); 
hAx=gca;                             
hAx.XTickLabel=hAx.XTickLabel;
xlabel("Number of regular services (in 6 months)","FontSize",20);
...
legend('Noise high','Noise low','Noise free','Baseline','fontsize',18,'edgecolor','w','Location','southeast'); 
hAx=gca;                             
hAx.XTickLabel=hAx.XTickLabel;
xlabel("Number of regular services (in 6 months)","FontSize",20);
